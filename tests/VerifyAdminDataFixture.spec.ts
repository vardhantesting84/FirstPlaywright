...
// const {customtest}  = require('../TestData/TestData.ts');
...
// customtest('Verify Admin',async ({page,adminData}) => {
//     const loginPage:LoginPage = new LoginPage(page);
//     const dashboardPage:DashboardPage = new DashboardPage(page);
//     const adminPage:AdminPage = new AdminPage(page);
...
//     await dashboardPage.ClickOnAdmin();
//     await page.waitForTimeout(3000);
//     await adminPage.SearchAdmin(adminData.user,adminData.expectedValue);
